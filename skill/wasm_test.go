...
func TestWasmModuleInterface(t *testing.T) {
	...
	var _ skill.WasmModule = (*mockWasmModule)(nil)
}

func TestWasmLoaderLoad(t *testing.T) {
	loader := skill.NewWasmLoader()
...
func TestWasmLoaderLoadFromPath(t *testing.T) {
	...
	_, err := loader.LoadFromPath(ctx, "/nonexistent/skill.wasm")
	if err == nil {
...
func (m *mockWasmModule) Execute(ctx context.Context, input skill.WasmInput) (*skill.WasmOutput, error) {
	return nil, nil
}
